    ...
    return (
        <>
            <CSection>
                ...
                <div className="absolute h-screen w-full right-0 main-padding flex justify-center md:justify-end items-end md:items-center transform-3d pointer-events-none">
